      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="lg:hidden border-b border-steel-200 bg-white sticky top-0 z-30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center gap-3">
            ...
            <h1 className="text-base sm:text-xl font-bold text-navy-900">Analytics</h1>
          </div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <h1 className="hidden lg:block text-2xl sm:text-3xl font-bold text-navy-900 mb-6 sm:mb-8">Analytics Overview</h1>
          
          <div className="bg-white border border-steel-200 rounded overflow-hidden p-4 sm:p-6">
