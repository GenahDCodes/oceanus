      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="lg:hidden border-b border-steel-200 bg-white sticky top-0 z-30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center">
            ...
            <h1 className="text-xl font-bold text-navy-900 ml-4">Operations Dashboard</h1>
          </div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="hidden lg:block text-3xl font-bold text-navy-900 mb-8">Operations Dashboard</h1>
          
          <MetricsCards shipments={shipments} />
          
          <div className="mt-8 bg-white border border-steel-200 rounded-lg overflow-hidden">
            <ShipmentTable shipments={shipments} onEdit={handleEdit} onDelete={handleDelete} />
          </div>

          <div className="mt-8 bg-white border border-steel-200 rounded-lg overflow-hidden p-6">
            <h2 className="text-xl font-bold text-navy-900 mb-6">Analytics Overview</h2>
